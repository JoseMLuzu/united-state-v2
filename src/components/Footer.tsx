      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-2 mb-6 md:mb-0">
            <div className="w-10 h-10 bg-gradient-accent rounded-sm flex items-center justify-center">
              <span className="text-accent-foreground font-bold">A</span>
            </div>
            <div>
              <div className="font-gaming font-semibold text-lg text-primary">ALBATROSS INTERACTIVE</div>
              <div className="text-sm text-muted-foreground">Game Development Studio</div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex space-x-4">
              <a href="#" className="social-icon hover:text-gaming-primary">
